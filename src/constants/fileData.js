export const csvFiles = [
  ...
  { name: 'restaurants', file: 'restaurants.csv' },
  { name: 'recipes', file: 'recipes.csv' },
...
export const tableConfigs = {
  employees: { 
    ...
    filterFields: {
      department: { type: 'select', values: ['Engineering', 'Marketing', 'Sales', 'HR'] },
  ...
  products: { 
    ...
    filterFields: {
      ...
      brand: { type: 'select', values: ['Italian Kitchen', 'TechCorp', 'GamerGear', 'Tropical Bites'] },
  ...
  recipes: { 
    ...
    filterFields: {
      ...
      type: { type: 'select', values: ['Base', 'Sauce', 'Main', 'Dessert', 'Salad'] },
  ...
  orders: { 
    ...
    filterFields: {
      status: { type: 'select', values: ['Delivered', 'Preparing', 'Cancelled'] },
